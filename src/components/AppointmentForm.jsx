        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 lg:p-10">
          <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
            ...
            <div className="pt-4 md:pt-6">
              <button
                type="submit"
                className="w-full bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-sm md:text-base"
              >
                Book Appointment
