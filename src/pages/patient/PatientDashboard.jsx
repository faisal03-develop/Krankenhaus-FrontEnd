          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => navigate('/patient/reports')} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                  View All
                </button>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  {reports.map((report) => (
                    <div key={report._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <button onClick={() => navigate(`/report/${report._id}`)} className="px-3 py-1 text-xs font-medium text-blue-600 bg-blue-50 rounded-full hover:bg-blue-100">
                        View
                      </button>
                    </div>
                  ))}
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  <strong>Tip:</strong> 
                      'Click "View All" to see the complete report including symptoms, observations, and doctor\'s remarks. You can also print your reports for your records.'
                </p>
              </div>
            </div>
          </div>
